                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img src="<?php
                                        $caminhoArquivo = $_SERVER['DOCUMENT_ROOT'] . "/kioficina/public/uploads/" . $cliente['foto_cliente'];

                                        if ($cliente['foto_cliente'] != "") {
                                            if (file_exists($caminhoArquivo)) {
                                                echo ("http://localhost/kioficina/public/uploads/" . htmlspecialchars($cliente['foto_cliente'], ENT_QUOTES, 'UTF-8'));
                                            } else {
                                        ...
                                        ?>" class="user-image rounded-circle shadow" alt="<?php echo $cliente['nome_cliente']; ?>">
                            <span class="d-none d-md-inline"><?php echo $cliente['nome_cliente']; ?></span>
                        </a>
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <li class="user-header text-bg-primary"> <img src="<?php
                                ...
                                <p>
                                    ...
                                    <small><?php echo $cliente['endereco_cliente'] . " - " . $cliente['telefone_cliente']; ?></small>
                                </p>
                            </li>
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <!-- Recursos do Site -->
                        <li class="nav-item">
                            <a href="http://localhost/kioficina/public/depoimentos/listar" class="nav-link">
        ...
        <main class="app-main">
            <div class="app-content-header">
                ...
                <div class="col-sm-6 text-primary">
                            <h3 class="mb-0 text-black" >Dashboard</h3>
                        </div>
                        <div class="col-sm-6">
