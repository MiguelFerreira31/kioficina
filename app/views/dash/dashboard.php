...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
                ...
                <nav class="mt-2">
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="http://localhost/kioficina/public/funcionarios/listar" class="nav-link">
    ...
    <script>
        ...
        function desativarServico(idServico) {
            ...
            fetch(`http://localhost/kioficina/public/servicos/desativar/${idServico}`, {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    ...
                    if (data.sucesso) {
                        console.log('servico desativado com sucesso');
                        $('#modalDesativer').modal('hide');
                        setTimeout(()=>{
                            location.reload();
                        }),500;
